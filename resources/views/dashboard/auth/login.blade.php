...
<head>
    ...
    <meta name="description" content="Arib  admin is super flexible, powerful, clean &amp; modern responsive bootstrap 4 admin template with unlimited possibilities.">
    <meta name="keywords" content="admin template, Arib  admin template, dashboard template, flat admin template, responsive admin template, web app">
    <meta name="author" content="PIXINVENT">
    <title>Arib  - Login </title>
    ...
    <link rel="stylesheet" type="text/css" href="{{asset('_dashboard/app-assets/css-rtl/themes/bordered-layout.css')}}">
    <link rel="stylesheet" type="text/css" href="{{asset('_dashboard/app-assets/css-rtl/themes/semi-dark-layout.css')}}">

    <!-- BEGIN: Page CSS-->
    <link rel="stylesheet" type="text/css" href="{{asset('_dashboard/app-assets/css-rtl/core/menu/menu-types/vertical-menu.css')}}">
    <link rel="stylesheet" type="text/css" href="{{asset('_dashboard/app-assets/css-rtl/plugins/forms/form-validation.css')}}">
                ...
                <div class="auth-inner my-2">
                    ...
                    <div class="card mb-0">
                        <div class="card-body">
                            ...
                            <h4 class="card-title mb-1">Welcome to Arib ! 👋</h4>
                            ...
                            @endif
                            <form class="auth-login-form mt-2" action="{{route('singIn')}}" method="POST">
                                @csrf
                                <div class="mb-1">
                                    ...
                                    <input type="text" class="form-control" id="login-email" name="username"
                                           placeholder="username" aria-describedby="login-email"
...
<script src="{{asset('_dashboard/app-assets/vendors/js/forms/validation/jquery.validate.min.js')}}"></script>
<!-- END: Page Vendor JS-->
...
<!-- BEGIN: Page JS-->
<script src="{{asset('_dashboard/app-assets/js/scripts/pages/auth-login.js')}}"></script>
<!-- END: Page JS-->
